...
<header id="fh5co-header-section" class="sticky-banner">
    <div class="container">
        <div class="nav-header">
            ...
            <h1 id="fh5co-logo"><a href="{{route('home')}}">SiTamkel</a></h1>
            <!-- START #fh5co-menu-wrap -->
                    ...
                    @if(\Illuminate\Support\Facades\Auth::guard('web')->check())
                        ...
                        <li><a href="{{route('logout.proses')}}"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                    @else
